...
function LandingPage() {
  ...
  return (
    <section className="showcase">
      ...
      <ul className="social">
        <li><a href="https://github.com/DETNAW11"><FaGithub /></a></li>
        <li><a href="https://www.linkedin.com/in/luis-alejandro-prieto-torres-992600261/"><FaLinkedin /></a></li>
        <li><a href="https://www.facebook.com/luisalejandro.prieto.12"><FaFacebookSquare /></a></li>
